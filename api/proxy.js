...
const ALLOW = [
  ...
  /(^|\.)news\.cn$/, /(^|\.)people\.com\.cn$/, /(^|\.)cctv\.com$/,
  /(^|\.)wikipedia\.org$/, /(^|\.)wikisource\.org$/, /(^|\.)ctext\.org$/,
  /(^|\.)bbc\.com$/, /(^|\.)chinesereadingpractice\.com$/, /(^|\.)chinese-at-ease\.com$/,
  /(^|\.)duchinese\.net$/, /(^|\.)mandarinbean\.com$/, /(^|\.)chineseboost\.com$/,
  /(^|\.)i\.ibb\.co$/
];
