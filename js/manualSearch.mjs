...
function setupUI(searchWrap) {
  ...
  function resetSeed() {
    ...
    // Include common extra sequences and variants from the reference recogniser
    COMMON_EXTRA.forEach(e => addEntry(e[0], e[1], e[2]));
    VARIANTS.forEach(e => addEntry(e[0], e[1], e[2]));
    // Additional canonical variants manually inserted (example).  These
    // entries match those defined in the original recogniser and are
    // included here to improve recognition fidelity.
