...
function forceLocalDiscover(){
  ...
  const dc=document.getElementById('dc');
  if(active&&dc&&!dc.querySelector('.hsrc-wrap'))renderDiscoverLoading();
}
function patchShowScreen(){
  ...
  const patched=function(id){
    if(id==='sd')renderDiscoverLoading();
    ...
    Promise.resolve().then(()=>{
      ...
      if(id==='sd')void renderDiscoverLocal();
    });
    return r;
  };
  patched.__hsrc = true;
...
[250,1200,4000].forEach(t=>setTimeout(boot,t));
})();
