...
const [writing, learning, practiceUi, audio, storage, lifecycle, css, script, index] = await Promise.all([
  ...
  readFile('css/refine-v51.css', 'utf8'), readFile('js/script.mjs', 'utf8'), readFile('index.html', 'utf8')
]);
