...
if(!script.includes('window.hzMusicController')||!script.includes('v43SetDucked'))bad('trilha não expõe controle central com audio ducking.');
else ok('trilha possui controle central e redução automática de volume');
